...
public class MazeGenerator
{
    ...
    public MazeGeneratorCell[,] GenerateMaze()
    {
        ...
        // Уведомление: Пустой лабиринт создан
        Debug.Log("Шаг 1: Создание пустого лабиринта выполнено успешно.");

        // Уведомление: Расстановка стен вокруг лабиринта
        for (int x = 0; x < maze.GetLength(0); x++)
        {
        ...
        Debug.Log("Шаг 2: Расстановка стен вокруг лабиринта выполнена успешно.");

        RemoveWallsWithBacktracker(maze);
        Debug.Log("Шаг 3-7: Генерация лабиринта в процессе...");

        PlaceMazeExit(maze);

        // Уведомление: Создание лабиринта завершено
        Debug.Log("Шаг 8: Создание лабиринта завершено успешно.");
    ...
    public Vector2Int PlaceMazeExit(MazeGeneratorCell[,] maze)
    {
